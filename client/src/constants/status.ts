...
export const STATUS_PRESENTATION: Record<SiteStatus, StatusPresentation> = {
  ONLINE: {
    label: 'Online',
    icon: Zap,
    text: 'text-[var(--color-online)]',
    background: 'bg-[var(--color-online-soft)]',
  ...
  SLOW: {
    label: 'Slow',
    icon: AlertTriangle,
    text: 'text-[var(--color-slow)]',
    background: 'bg-[var(--color-slow-soft)]',
    dot: 'bg-[var(--color-slow)]',
  ...
  OFFLINE: {
    ...
    background: 'bg-[var(--color-offline-soft)]',
  ...
  CHECKING: {
    ...
    background: 'bg-[var(--color-brand-50)]',
  ...
  PAUSED: {
    ...
    background: 'bg-[var(--color-paused-soft)]',
